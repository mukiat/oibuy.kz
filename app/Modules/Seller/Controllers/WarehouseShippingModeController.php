...
class WarehouseShippingModeController extends InitController
{
    public function index()
    {
        ...
        elseif ($_REQUEST['act'] == 'freight') {
            ...
            $plugin = plugin_path('Shipping/' . StrRepository::studly($row['shipping_code']) . '/config.php');
            include_once($plugin);
        ...
        elseif ($_REQUEST['act'] == 'update') {
            ...
            $plugin = plugin_path('Shipping/' . StrRepository::studly($shipping_code) . '/config.php');
