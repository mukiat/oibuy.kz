...
class GoodsServicesLabelController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $offset = $this->pageLimit(route('seller/goodsserviceslabel/list', $filter), $this->page_num);
        ...
        if ($is_ajax == 1) {
            $respond['content'] = $this->fetch('seller.goodsserviceslabel.library.list_query');
    ...
    public function bind_goods(Request $request)
    {
        ...
        $offset = $this->pageLimit(route('seller/goodsserviceslabel/bind_goods', $filter), $this->page_num);
        ...
        $is_ajax = $request->input('is_ajax');
        if ($is_ajax == 1) {
            $respond['content'] = $this->fetch('seller.goodsserviceslabel.library.bind_goods_query');
            $respond['filter'] = $filter;
            $respond['page_count'] = $page['page_count'] ?? 1;
            return response()->json($respond);
        }
    ...
    public function select_goods(Request $request)
    {
        ...
        $filter['label_id'] = $label_id;
        $filter['ru_id'] = $this->ru_id;
        $offset = $this->pageLimit(route('seller/goodsserviceslabel/select_goods', $filter), $this->page_num);
