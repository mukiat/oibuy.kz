...
$_LANG = array(
    ...
    'upload_warehouse_attr' =>
        array(
            'goods_id' => 'Product id',
            'goods_name' => 'Name of commodity',
            'shop_name' => 'Vendor name',
            'seller_id' => 'Merchant ID',
            'region_name' => 'The name of the warehouse',
            'attr_name' => 'The attribute name',
            'attr_price' => 'Property prices',
            'state' => 'state',
        ),
    'save_products' => 'Save commodity warehouse attribute successfully',
    'add_area_batch' => 'Continue to add warehouse properties in bulk',
    '13_batch_add' => 'Bulk upload of warehouse property price',
