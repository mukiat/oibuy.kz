...
$_LANG = array(
    ...
    'use_help' => 'According to usage habits, download CSV files in corresponding languages. For example, mainland Chinese users download files in simplified Chinese language and Hong Kong and Taiwan users download files in traditional Chinese language. Select the classification and file encoding of the uploaded goods, and upload CSV file </li></ul>',
    ...
    'upload_area' =>
        array(
            ...
            'area_name' => 'Province/municipality',
            'city_name' => 'The city/county',
    ...
    'save_products' => 'Preserve merchandise area success',
    'add_area_batch' => 'Continue to add merchandise areas in bulk',
    '13_batch_add' => 'Goods area bulk upload',
);
