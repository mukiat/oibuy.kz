...
$_LANG['notice_start_team_date'] = '開團有效期不能爲空!寫入時間不能小於一小時(時間格式:小時,請輸入有效數字數1 ~ 100字)';
...
$_LANG['js_languages']['jl_validity_time_not_null'] = '開團有效期不能爲空!寫入時間不能小於一小時(時間格式:小時,請輸入有效數字數1 ~ 100字)';
