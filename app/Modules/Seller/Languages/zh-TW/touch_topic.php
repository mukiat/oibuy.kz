...
$_LANG['js_languages']['select_remove_cat'] = '請選擇刪除分類';
$_LANG['js_languages']['select_cat_add'] = '請先選擇分類，如果沒有分類先添加分類';
$_LANG['js_languages']['jl_upload_banner_img'] = '請上傳banner圖';
$_LANG['js_languages']['jl_add_topic_cat'] = '請先添加專題分類';
...
$_LANG['operation_prompt_content']['list'][1] = '可進行發布廣告、發布Flash播放等操作。';
