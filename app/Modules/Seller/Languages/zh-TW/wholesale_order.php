...
$_LANG['label_order_remarks'] = '訂單備註：';
...
$_LANG['label_cost_amount'] = '凈利潤約';
$_LANG['search_logistics_info'] = '正在查詢物流信息，請稍後...';
$_LANG['confirm_pay'] = '確定支付嗎？';
$_LANG['set_robbing'] = '設置搶單';
$_LANG['wholesale_order_list'] = '采購訂單列表';
$_LANG['order_keywords_placeholder'] = '訂單編號/商品編號/商品關鍵字';
$_LANG['download_order'] = '導出訂單';
$_LANG['merge_order'] = '合並訂單';
$_LANG['not_pay_repeat'] = '不能重復付款！';
...
/* 頁面頂部操作提示 */
$_LANG['operation_prompt_content']['list'][0] = '顯示采購訂單列表信息';

$_LANG['operation_prompt_content']['delivery_list'][0] = '供應商已發貨的訂單列表管理。';
$_LANG['operation_prompt_content']['delivery_list'][1] = '可通過訂單號進行查詢。';


$_LANG['js_languages']['jl_confirm_pay'] = '確定支付嗎？';
$_LANG['js_languages']['jl_set_rob'] = '設置搶單';
$_LANG['js_languages']['jl_consignee_info'] = '收貨人信息';
