...
$_LANG['js_languages']['password_invaild'] = '密码必须同时包含大小写字母及数字且长度不能小于8位!';
...
$_LANG['js_languages']['new_password_error'] = '密码长度不能小于8位';
$_LANG['js_languages']['password_error'] = '两次输入的密码不一致!';
$_LANG['js_languages']['captcha_empty'] = '您没有输入验证码!';
...
// 社区团购
$_LANG['groupbuy'] = '社区团购';
$_LANG['groupbuy_goods_manage'] = '商品列表';
$_LANG['groupbuy_order_manage'] = '订单列表';
$_LANG['leader_settlement_manage'] = '团长结算';
$_LANG['post_setting_manage'] = '驿站设置';
