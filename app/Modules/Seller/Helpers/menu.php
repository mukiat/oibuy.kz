...
$modules['19_merchants_store']['address_manage'] = 'address_manage?act=list';

// 商城-商品-商品标签
$modules['02_cat_and_goods']['25_goods_label'] = 'goodslabel'; // 2.2.1 标签

// 商城-商品-服务标签
$modules['02_cat_and_goods']['28_goods_services_label'] = 'goodsserviceslabel'; // 2.2.2 服务标签

// 加载Modules模块自定义菜单（商家后台）
$modules_list = glob(app_path('Modules/*/menu_seller.php'));
