...
//商品库存管理权限
$purview['13_goods_inventory_logs'] = 'storage_put';
$purview['13_goods_inventory_logs'] = 'storage_out';
...
$purview['02_seller_follow'] = 'seller_follow';
...
$purview['11_touch_dashboard_wxapp'] = 'touch_dashboard';
$purview['11_touch_dashboard_app'] = 'touch_dashboard';
...
// 加载模块后台权限配置（商家权限）
$modules_list = glob(app_path('Modules/*/priv_seller.php'));
