...
$_LANG['order_sn'] = '訂單號';
$_LANG['surplus'] = '使用余額';
$_LANG['integral_money'] = '積分使用余額';
$_LANG['add_time'] = '訂單時間';
$_LANG['view_order'] = '查看訂單';
$_LANG['user_account_info'] = '會員賬戶信息';
$_LANG['user_add_money'] = '用戶充值總額';
$_LANG['user_repay_money'] = '退款/提現金額';
$_LANG['user_money'] = '用戶可用資金';
$_LANG['frozen_money'] = '用戶凍結資金';
$_LANG['surplus_info'] = '余額使用信息';
$_LANG['order_surplus'] = '交易使用余額';
$_LANG['integral_money'] = '積分使用余額';
$_LANG['view'] = '查看';
$_LANG['start_end_date'] = '起止時間';

/* 頁面頂部操作提示 */
$_LANG['operation_prompt_content']['list'][0] = '搜索某個時間的商城用戶充值總額。';
$_LANG['operation_prompt_content']['list'][1] = '搜索出來的信息只能查看不能修改。';
