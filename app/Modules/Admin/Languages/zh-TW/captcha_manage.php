...
$_LANG['captcha_font_size'] = '驗證碼內容大小';
$_LANG['comt_font_size'] = '(如：font-size:18)';
$_LANG['captcha_length'] = '驗證碼位數';
...
$_LANG['width_note'] = '驗證碼圖片的寬度，范圍在 40～145 之間';
$_LANG['captcha_height'] = '驗證碼圖片高度';
$_LANG['height_note'] = '驗證碼圖片的高度，范圍在 15～50 之間';
...
/* 教程名稱 */
$_LANG['tutorials_bonus_list_one'] = '商城驗證碼設置操作說明';

/* 頁面頂部操作提示 */
$_LANG['operation_prompt_content'][0] = '該功能可以設置開啟驗證碼的場景。';
$_LANG['operation_prompt_content'][1] = '可以設置驗證碼的高度、寬度和大小。';
$_LANG['operation_prompt_content'][2] = '請按照每個操作下的提示進行設置。';
