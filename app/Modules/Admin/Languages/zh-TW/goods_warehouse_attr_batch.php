...
// 批量上傳商品的欄位
$_LANG['upload_warehouse_attr']['goods_id'] = '商品編號';
$_LANG['upload_warehouse_attr']['goods_name'] = '商品名稱';
$_LANG['upload_warehouse_attr']['shop_name'] = '商家名稱';
$_LANG['upload_warehouse_attr']['seller_id'] = '商家ID';
$_LANG['upload_warehouse_attr']['region_name'] = '倉庫名稱';
$_LANG['upload_warehouse_attr']['attr_name'] = '屬性名稱';
$_LANG['upload_warehouse_attr']['attr_price'] = '屬性價格';
$_LANG['upload_warehouse_attr']['state'] = '狀態';

$_LANG['save_products'] = '保存商品倉庫屬性成功';
$_LANG['add_area_batch'] = '繼續批量添加商品倉庫屬性';

$_LANG['13_batch_add'] = '倉庫屬性價格批量上傳';
