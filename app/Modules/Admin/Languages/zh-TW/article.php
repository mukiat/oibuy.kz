<?php
$_LANG['related_goods_list'] = '關聯商品列表';
$_LANG['title'] = '文章標題';
$_LANG['cat'] = '文章分類';
$_LANG['content'] = '文章內容';
$_LANG['reserve'] = '保留';
...
$_LANG['upload_file_notic'] = '圖片尺寸280*160';
...
$_LANG['not_min_cat'] = '存在下級分類，無法在該分類下添加/編輯文章';
...
$_LANG['no_select_type'] = '未選擇批量修改的方式';
...
$_LANG['all_cat'] = '全部分類';
$_LANG['article_news'] = 'News裝修';

$_LANG['back_edit_article_content'] = '返回編輯文章內容';
$_LANG['delete_upload_file_success'] = '刪除上傳文件成功！';

/* 頁面頂部操作提示 */
$_LANG['operation_prompt_content'][0] = '該頁面展示所有分類下的文章。';
$_LANG['operation_prompt_content'][1] = '可通過搜索文章標題進行搜索，側邊欄可進行高級搜索。';

$_LANG['operation_prompt_content']['info'][0] = '請注意選擇文章分類；請嚴謹描述文章內容。';
