...
$_LANG['search_languages'] = '請先搜索語言包';
...
/* 頁面頂部操作提示 */
$_LANG['operation_prompt_content']['list'][0] = '選擇語言包和需要修改的關鍵字進行搜索。';
$_LANG['operation_prompt_content']['list'][1] = '修改語言包對應的內容。';
$_LANG['operation_prompt_content']['list'][2] = '請謹慎操作，如出現錯誤可還原。';
