...
$_LANG['cat_grade'][1] = '一級分類';
$_LANG['cat_grade'][2] = '二級分類';
$_LANG['cat_grade'][3] = '三級分類';
$_LANG['cat_grade'][4] = '四級分類';
$_LANG['cat_grade'][5] = '五級分類';
...
$_LANG['has_article_on_this_cat'] = '該分類下存在文章，無法添加子分類';
...
/* 頁面頂部操作提示 */
$_LANG['operation_prompt_content'][0] = '該頁面展示所有文章分類。';
$_LANG['operation_prompt_content'][1] = '可添加子分類以及編輯修改、刪除分類。';
$_LANG['operation_prompt_content'][2] = '請注意選擇上級分類。';
