...
/* 頁面頂部操作提示 */
$_LANG['operation_prompt_content']['info'][0] = '請注意設置調查主題的日期。';

$_LANG['operation_prompt_content']['list'][0] = '在線調查列表展示所有的在線調查問題。';
$_LANG['operation_prompt_content']['list'][1] = '在線調查是添加調查問題在前台展示，用戶對相應的問題提出見解，平台收集相應信息。';

$_LANG['operation_prompt_content']['option'][0] = '調查選項為調查主題配置，請合理設置。';
$_LANG['operation_prompt_content']['option'][1] = '調查主題可根據關鍵字搜索。';
