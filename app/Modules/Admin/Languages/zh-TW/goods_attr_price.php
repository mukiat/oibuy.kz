...
// 批量上傳商品的欄位
$_LANG['upload_area_attr']['goods_sn'] = '商品貨號';
$_LANG['upload_area_attr']['goods_attr'] = '商品屬性';
$_LANG['upload_area_attr']['attr_sort'] = '排序';
$_LANG['upload_area_attr']['attr_price'] = '屬性價格';

$_LANG['upload_goods_attr']['goods_sn'] = '商品貨號';
$_LANG['upload_goods_attr']['goods_attr'] = '商品屬性';
$_LANG['upload_goods_attr']['attr_price'] = '屬性價格';
$_LANG['upload_goods_attr']['goods_number'] = '屬性庫存';

$_LANG['save_products'] = '保存商品地區屬性成功';
$_LANG['add_area_batch'] = '繼續批量添加商品地區屬性';

$_LANG['13_batch_add'] = '批量上傳屬性價格';
