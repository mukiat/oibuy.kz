...
$_LANG['different_domain'] = '您設置的整合對象和大商創不在同一域下。<br />您將只能共享該系統的會員數據，但無法實現同時登錄。';
...
$_LANG['user_help'] = '<li>如果需要整合其他的用戶系統，可以安裝適當的UCenter版本號插件進行整合。</li><li>可在UCenter中整合其他系統，整合通信成功即可。</li>';
...
/* 表單相關語言項 */
$_LANG['db_notice'] = '請正確填寫 uc_server 所在的 URL，不要以 / 結尾。';

$_LANG['lable_db_host'] = '資料庫伺服器主機名：';
$_LANG['lable_db_name'] = '資料庫名：';
$_LANG['lable_db_chartset'] = '資料庫字元集：';
...
$_LANG['invalid_db_charset'] = '整合資料庫檢測到是%s 字元集，而非%s 字元集';
...
$_LANG['ucenter_lab_tag_number'] = 'TAG 標簽顯示數量:';
...
$_LANG['ucenter_notice_key'] = '通信密鑰用於在 UCenter 和 DSCmall 之間傳輸信息的加密，可包含任何字母及數字，請在 UCenter 與 DSCmall 設置完全相同的通訊密鑰，以確保兩套系統能夠正常通信';
...
$_LANG['uc_notice_ip'] = '連接的過程中出了點問題，請您填寫伺服器 IP 地址，如果您的 UC 與 DSCmall 裝在同一伺服器上，我們建議您嘗試填寫 127.0.0.1';
