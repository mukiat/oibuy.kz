...
$_LANG['full_backup'] = '全部備份(推薦)';
$_LANG['full_backup_note'] = '備份資料庫所有表';
$_LANG['stand_backup'] = '標准備份';
...
$_LANG['notice_use_new_pre'] = '只有在恢復全部備份時才可以選擇「是」，否則沒有備份的表將無法使用。<br />您也可以手動修改 data/config.php 中的 $prefix 變數來決定使用哪個表前綴';
...
$_LANG['unrecognize_version'] = '不能識別備份sql的大商創版本';
...
$_LANG['version_error'] = '大商創 當前版本%s與備份數據版本%s不同，備份恢復失敗';
...
$_LANG['backup_notice'] = '如果您的瀏覽器沒有自動跳轉，請點擊這里';
...
/* 頁面頂部操作提示 */
$_LANG['operation_prompt_content']['backup'][0] = '請先選擇備份類型。';
$_LANG['operation_prompt_content']['backup'][1] = '請謹慎設置備份，以免出錯。';

$_LANG['operation_prompt_content']['restore'][0] = '該頁面展示商城所有功能許可權。';
$_LANG['operation_prompt_content']['restore'][1] = '打鉤即是分配許可權，請謹慎操作。';

$_LANG['operation_prompt_content']['optimize'][0] = '手動清理數據表碎片。';
$_LANG['operation_prompt_content']['optimize'][1] = '定期清理數據表碎片可以提升資料庫的查詢速度。';
