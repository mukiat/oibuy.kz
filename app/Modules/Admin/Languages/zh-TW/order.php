...
$_LANG['label_value_card_discount'] = '儲值卡折扣：';
$_LANG['label_goods_value_card'] = '含使用儲值卡金額：';
...
$_LANG['label_contain'] = "含運費";
$_LANG['label_goods_paid_card'] = "儲值卡支付金額";
$_LANG['label_among'] = "其中";

$_LANG['label_return_rate_price'] = "退稅費";
$_LANG['label_return_val_card'] = "可退儲值卡金額";
$_LANG['label_return_pay_money'] = "可退已付款金額";
$_LANG['label_return_integral'] = "可退積分";
$_LANG['label_return_shipping_fee'] = "可退運費金額";
$_LANG['label_return_total'] = "可退合計金額";

$_LANG['label_pay_actual_return'] = "已退付款金額";
$_LANG['label_return_is_shipping_fee'] = "已退運費金額";
$_LANG['label_actual_value_card'] = "已退儲值卡金額";
$_LANG['label_integral_money'] = "已退積分金額";
