...
$_LANG['please_enter_label_name'] = '请输入标签名称';
$_LANG['add_label_notice'] = '每个商品最多可添加3个标签';
$_LANG['confirm'] = '确定';
$_LANG['remove'] = '移除';
...
$_LANG['add_services_label_notice'] = '勾选退货标识默认支持7天无理由退货，无需重复设置';
