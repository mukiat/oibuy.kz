...
$_LANG['cause_repeat'] = "Қайтару себептерінің түрлер атауы қайталанып кетті";
...
$_LANG['application_information'] = 'Өтініш инфосы';
$_LANG['other_express'] = 'Басқа тасымал';

$_LANG['order_id'] = 'Заказ ID';
$_LANG['business_id'] = 'Сатушы ID';
$_LANG['suborder_quantity'] = 'Қосымша заказдар саны';
...
$_LANG['action_child_order'] = 'Қосымша заказды атқару';
...
$_LANG['ps_not_same'] = 'Біріктіретін екі төлемнің күйлері сәйкес болмауы керек.';
...
$_LANG['js_languages']['pls_input_should_return'] = 'Қайтаратын нақты сомадан асып кетті,максимум қайтаратын сома：';
$_LANG['js_languages']['pls_input_shipping_fee'] = 'Қайтаратын тасымал ақысынан асып кетті,максимум тасымал ақысы：';
...
$_LANG['order_status_07'] = 'Бастарту';
$_LANG['order_status_08'] = 'Жарамсыз';
$_LANG['order_status_09'] = 'Тауар қайтаруда';
...
$_LANG['refund_type_notic_six'] = "Онлайн ақша қайтару өтініші сәтсіз,төлем түрін қойғаныңызға көз жеткізіңіз,немесе шотта жеткілікті қаражат бар екенін анықтаңыз немесе кеңесшіден көмек сұраңыз";
...
$_LANG['js_languages']['price_format_support_1_decimal'] = 'Баға тек 1 орынды сан болуы керек';
$_LANG['js_languages']['price_format_support_2_decimal'] = 'Баға тек 2 орынды сан болуы керек';
...
$_LANG['seller_return_agree'] = "Сатушы мақұлдауын күту";
