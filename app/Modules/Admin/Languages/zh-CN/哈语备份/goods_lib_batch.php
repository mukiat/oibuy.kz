...
$_LANG['upload_goods_lib']['integral'] = 'Бонуспен алу лимиті';
...
$_LANG['upload_goods_lib']['goods_number'] = 'Қор саны';
$_LANG['upload_goods_lib']['warn_number'] = 'Қорды ескерту саны';
$_LANG['upload_goods_lib']['is_best'] = 'Үздік';
$_LANG['upload_goods_lib']['is_new'] = 'Жаңа';
$_LANG['upload_goods_lib']['is_hot'] = 'Хит';
$_LANG['upload_goods_lib']['is_on_sale'] = 'Сөреге';
$_LANG['upload_goods_lib']['is_alone_sale'] = 'Кәдімгі тауар ретінде сату';
$_LANG['upload_goods_lib']['is_real'] = 'Шынайы тауар ма';

$_LANG['batch_upload_ok'] = 'Топпен жүктеу сәтті';
$_LANG['goods_upload_confirm'] = 'Топпен жүктеуді растау';
