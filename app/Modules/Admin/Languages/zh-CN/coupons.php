...
$_LANG['js_languages']['coupons_receive_empty'] = '领取开始时间不能为空';
$_LANG['js_languages']['coupons_receive_invalid_gt'] = '领取结束时间必须大于有效开始时间';
...
$_LANG['receive_start_enddate'] = '领取时间';
...
$_LANG['used_drop_confirm'] = '当前优惠券已使用，删除可能导致部分数据显示错误，是否删除？';
...
$_LANG['valid_day_num'] = '领取有效天数';
$_LANG['valid_day_num_desc'] = '优惠券用户领取成功后开始计算的有效时间，例：领取时间 2021-12-08 09:00:00, 有效5天则 2021-12-13 09:00:00 前可用';
$_LANG['js_languages']['coupons_valid_day_num_empty'] = '领取有效天数不能为空';
$_LANG['js_languages']['valid_day_num_min'] = '天数最小值为1天';

$_LANG['valid_end_time'] = '可使用截止时间';
$_LANG['valid_type'] = '有效期类型';
$_LANG['valid_type_desc'][1] = '按有效区间';
$_LANG['valid_type_desc'][2] = '按领取有效天数';
