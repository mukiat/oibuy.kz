...
$_LANG['unsetting'] = '未设置';
$_LANG['no_wu'] = '暂无';
$_LANG['expiry_type_forever'] = '永久有效';
$_LANG['is_use'] = '可使用';
$_LANG['is_used'] = '已使用';
$_LANG['cant_use'] = '已过期';
$_LANG['coupons_info'] = '优惠券信息';
$_LANG['sure_drop_coupons'] = '确定删除此账户下的优惠券吗？';
$_LANG['value_card_info'] = '储值卡信息';
$_LANG['expiration_time'] = '过期时间';
$_LANG['enter_value_card_name'] = '请输入储值卡名称';
$_LANG['enter_bonus_name'] = '请输入红包名称';
$_LANG['bonus_info'] = '红包信息';
$_LANG['sure_drop_bonus'] = '确定删除此账户下的红包吗？';
$_LANG['user_aff_level'][1] = '一级';
$_LANG['user_aff_level'][2] = '二级';
$_LANG['user_aff_level'][3] = '三级';
$_LANG['user_aff_level'][4] = '四级';
$_LANG['person'] = '人';
$_LANG['reg_time'] = '注册时间';
$_LANG['enjoy_rights'] = '享受权益';
$_LANG['rights_times'] = '权益有效期';
$_LANG['aff_info'] = '推荐信息';
$_LANG['unbind'] = "解绑";
$_LANG['low_lever_mer'] = "下级会员";
$_LANG['aff_user'] = "推荐会员";
$_LANG['aff_order'] = "推荐订单";
$_LANG['real_user_info'] = "认证信息";
$_LANG['ID_photo'] = "证件图片";
$_LANG['acc_money'] = "账户资金";
$_LANG['can_use_money'] = "可用金额";
$_LANG['change_acc_money'] = "调节账户资金";
$_LANG['capital_details'] = "资金明细";
$_LANG['coup_info'] = "优惠信息";
$_LANG['can_available_bonus']= "可用红包";
$_LANG['can_available_coupons']= "可用优惠券";
$_LANG['can_available_valuecard']= "可用储值卡";
$_LANG['add_manger']= "地址管理";
$_LANG['consignee_name'] = '收货人姓名';
$_LANG['consignee_area'] = '所在地区';
$_LANG['detail_address'] = '详细地址';
$_LANG['ranks_info'] = '等级信息';
$_LANG['not_real'] = '未认证';
...
$_LANG['remove_supplier_fail'] = "%s 当前会员账号有供应商/入驻商关联，禁止删除";
...
$_LANG['js_languages']['less_password'] = '输入的密码不能少于8位。';
...
$_LANG['js_languages']['password_len_err'] = '新密码和确认密码的长度不能小于8位';
$_LANG['js_languages']['remove_log_confirm'] = '您确定要删除该会员操作日志吗？';
$_LANG['js_languages']['phone_number_incorrect'] = '手机号码格式不正确';
