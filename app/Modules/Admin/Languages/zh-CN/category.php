...
$_LANG['h5_phone_catads_url'] = 'H5分类列表广告链接';
$_LANG['wx_phone_catads_url'] = '小程序分类列表广告链接';
$_LANG['app_phone_catads_url'] = 'APP分类列表广告链接';
...
$_LANG['js_languages']['change_unit_prompt'] = '将更新此分类下所有商品的单位，是否确定修改？';
