...
$_LANG['upper_shelf'] = '上架，当商品处于非上架状态时，前台将不能浏览该商品，店主可控制商品上架状态。';
$_LANG['lower_shelf'] = '违规下架，当商品处于违规下架状态时，前台将不能购买该商品，只有管理员可控制商品违规下架状态，并且商品只有重新编辑后才能上架。';
$_LANG['set_item_info'] = '设置项中可以查看商品详细、查看商品SKU。查看商品详细，跳转到商品详细页。查看商品SKU，显示商品的SKU、图片、价格、库存信息。';

$_LANG['add_member'] = '可从管理平台手动添加一名新会员，并填写相关信息。';
$_LANG['required'] = '标识“<em>*</em>”的选项为必填项，其余为选填项。';
$_LANG['member_operation'] = '新增会员后可从会员列表中找到该条数据，并再次进行编辑操作，但该会员名称不可变。';
