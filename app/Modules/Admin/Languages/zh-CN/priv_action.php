...
$_LANG['express_setting'] = '快递跟踪配置';
$_LANG['open_api'] = '开放对外接口';
$_LANG['api'] = '接口对接';
$_LANG['upgrade'] = '在线升级';
$_LANG['country_manage'] = '国家列表';
$_LANG['cross_warehouse_manage'] = '跨境仓库';
$_LANG['filter_words'] = '词语过滤';
...
$_LANG['touch_nav_admin'] = '自定义工具栏';
$_LANG['touch_ad'] = '广告管理';
$_LANG['touch_ad_position'] = '广告位管理';
$_LANG['touch_dashboard'] = '可视化装修';
$_LANG['touch_page_nav'] = '发现页管理';
$_LANG['consult_set'] = '首页咨询设置';
...
if (file_exists(MOBILE_APP)) {
    ...
    $_LANG['app_client_manage'] = 'APP客户端管理';
    $_LANG['app_touch_visual'] = '可视化装修';
    $_LANG['app_touch_page_nav'] = 'APP发现页管理';
    $_LANG['app_touch_nav_admin'] = '自定义工具栏';
    $_LANG['app_client_setting'] = 'APP设置';
}
