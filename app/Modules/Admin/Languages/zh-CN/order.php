...
$_LANG['return_online_notice'] = '在线支付含使用余额时，使用余额支付部分会退还至会员余额，其他部分原路退回。';
$_LANG['return_reason_desc'] = '原因描述';
$_LANG['status_agree_apply'][0] = '待审核';
$_LANG['status_agree_apply'][1] = '已审核';
$_LANG['status_is_check'][0] = '待审批';
$_LANG['status_is_check'][1] = '已审批';
$_LANG['label_return_check'] = '退款审批';
$_LANG['label_return_check_2'] = '无须审批';
//退换货 end
...
$_LANG['op_assign'] = '指派给';
$_LANG['op_after_service'] = '备注';// 原'售后';
$_LANG['act_ok'] = '操作成功';
...
$_LANG['label_vc_dis_money'] = '储值卡折扣：';
...
$_LANG['js_languages']['pls_select_refund_cause'] = '请选择退换货原因！';
...
$_LANG['create_user_account_notice'] = '勾选并确定后订单未发货则生成会员提现申请，订单已发货则生成会员提现申请同时生成退货单';
...
$_LANG['invoice_no_notice'] = '发货单号仅支持字母或数字！';
...
$_LANG['js_languages']['jl_order_step_js_notic_10'] = '您修改的费用信息折扣不能大于商品总金额';
...
$_LANG['average_favourable'] = "均摊折扣金额：%s";
$_LANG['average_value_card'] = "均摊使用储值卡金额：%s";
$_LANG['average_card_discount'] = "均摊储值卡折扣金额：%s";
$_LANG['average_goods_integral_money'] = "均摊积分金额：%s";

$_LANG['label_value_card_discount'] = '储值卡折扣：';
$_LANG['label_goods_value_card'] = '含使用储值卡金额：';

$_LANG['label_contain'] = "含运费";
$_LANG['label_goods_paid_card'] = "使用储值卡金额";
$_LANG['label_among'] = "其中";

$_LANG['label_return_rate_price'] = "退税费";
$_LANG['label_return_val_card'] = "可退储值卡金额";
$_LANG['label_return_pay_money'] = "可退已付款金额";
$_LANG['label_return_integral'] = "可退积分";
$_LANG['label_return_shipping_fee'] = "可退运费金额";
$_LANG['label_return_total'] = "可退合计金额";

$_LANG['label_pay_actual_return'] = "已退付款金额";
$_LANG['label_return_is_shipping_fee'] = "已退运费金额";
$_LANG['label_actual_value_card'] = "已退储值卡金额";
$_LANG['label_integral_money'] = "已退积分金额";

$_LANG['order_team_ok'] = "【拼团订单】已成团，已拼人数：%s";
$_LANG['order_team_false'] = "【拼团订单】未成团，已拼人数：%s，差团人数：%s";

$_LANG['see_pay_document'] = "查看汇款凭证";

$_LANG['seller_return_agree'] = "待商家同意";
