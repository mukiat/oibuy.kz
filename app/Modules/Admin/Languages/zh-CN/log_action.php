...
$_LANG['log_action']['process_type_0'] = '会员充值申请';
$_LANG['log_action']['process_type_1'] = '会员提现申请';
...
$_LANG['log_action']['admin_logout'] = '管理员退出'; //管理员退出
...
$_LANG['log_action']['order_delayed'] = '延迟收货';

$_LANG['log_action']['edit_merchants_audit'] = '审核店铺->';
$_LANG['log_action']['merchants_audit_zero'] = '未审核';
$_LANG['log_action']['merchants_audit_one'] = '审核已通过';
$_LANG['log_action']['merchants_audit_two'] = '审核未通过';
$_LANG['log_action']['merchants_audit_three'] = '审核未通过，店铺重新申请';
