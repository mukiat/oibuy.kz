...
class GoodsWarehouseAttrController extends InitController
{
    ...
    public function index()
    {
        ...
        elseif ($act == 'product_list') {
            ...
            /* 是否存在商品id */
            if (empty($goods_id)) {
                $link[] = ['href' => 'goods.php?act=list', 'text' => __('admin::goods_warehouse_attr.cannot_found_goods')];
                return sys_msg(__('admin::goods_warehouse_attr.cannot_found_goods'), 1, $link);
            } else {
            ...
            $this->smarty->assign('sn', sprintf(__('admin::goods_warehouse_attr.good_goods_sn'), $goods['goods_sn']));
            $this->smarty->assign('price', sprintf(__('admin::goods_warehouse_attr.good_shop_price'), $goods['shop_price']));
            $this->smarty->assign('goods_name', sprintf(__('admin::goods_warehouse_attr.products_title'), $goods['goods_name']));
            $this->smarty->assign('goods_sn', sprintf(__('admin::goods_warehouse_attr.products_title_2'), $goods['goods_sn']));
            ...
            if (empty($attribute)) {
                ...
                return sys_msg(__('admin::goods_warehouse_attr.not_exist_goods_attr'), 1, $link);
            }
        ...
        elseif ($act == 'product_query') {
            ...
            /* 是否存在商品id */
            if (empty($goods_id)) {
                return make_json_error(__('admin::common.sys.wrong') . __('admin::goods_warehouse_attr.cannot_found_goods'));
            }
        ...
        elseif ($act == 'edit_product_sn') {
            ...
            $product_sn = json_str_iconv(request()->get('val', ''));
            ...
            if ($this->goodsWarehouseAttrManageService->checkProductWarehouseSnExist($product_sn, $product_id, $adminru['ru_id'])) {
                return make_json_error(__('admin::common.sys.wrong') . __('admin::goods_warehouse_attr.exist_same_product_sn'));
            }
        ...
        elseif ($act == 'edit_bar_code') {
            ...
            $product_id = request()->get('id', 0);
            $bar_code = json_str_iconv(request()->get('val', ''));

            if ($this->goodsWarehouseAttrManageService->checkProductWarehouseSnExist($bar_code, $product_id, $adminru['ru_id'], 1)) {
                return make_json_error(__('admin::common.sys.wrong') . __('admin::goods_warehouse_attr.exist_same_bar_code'));
            }
        ...
        elseif ($act == 'edit_product_number') {
            ...
            $product_id = request()->get('id', 0);
            $product_number = request()->get('val', 0);
        ...
        elseif ($act == 'product_remove') {
            ...
            /* 是否存在商品id */
            if (empty($product_id)) {
                return make_json_error(__('admin::goods_warehouse_attr.product_id_null'));
            } else {
        ...
        elseif ($act == 'product_add_execute') {
            ...
            $product['goods_id'] = request()->get('goods_id', 0);
            ...
            $product['warehouse_id'] = request()->get('warehouse_id', 0);

            /* 是否存在商品id */
            if (empty($product['goods_id'])) {
                return sys_msg(__('admin::common.sys.wrong') . __('admin::goods_warehouse_attr.cannot_found_goods'), 1, [], false);
            }
            ...
            if ($insert) {
                ...
                $link[] = ['href' => 'goods.php?act=list', 'text' => __('admin::common.01_goods_list')];
                $link[] = ['href' => 'goods_warehouse_attr.php?act=product_list&goods_id=' . $product['goods_id'] . '&warehouse_id=' . $product['warehouse_id'], 'text' => __('admin::common.18_product_list')];
            } else {
            ...
            return sys_msg(__('admin::goods_warehouse_attr.save_products'), 0, $link);
        }
    }
}
