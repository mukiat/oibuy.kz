        ...
        if ($_REQUEST['act'] == 'view') {
            ...
            if (!$is_multi) {
                ...
                foreach ($start_date_arr as $k => $val) {
                    $seriesName = TimeRepository::getLocalDate('Y-m', $start_date_arr[$k]);
            ...
            if (!$is_multi) {
                ...
                $area_arr = [];
                foreach ($res as $val) {
                    $date = TimeRepository::getLocalDate('Y-m', $val['access_time']);
                ...
                foreach ($start_date_arr as $val) {
                    $key++;
                    $date = TimeRepository::getLocalDate('Y-m', $val);
