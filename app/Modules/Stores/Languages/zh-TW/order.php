...
// 门店核销
$_LANG['store_id_required'] = "門店id不能爲空";
$_LANG['order_id_required'] = "訂單id不能爲空";
$_LANG['pick_code_required'] = "請輸入提貨碼或訂單號";
$_LANG['store_order_empty'] = "未找到符合條件門店訂單";
$_LANG['store_order_picked_up'] = "門店訂單已提貨";
// 提货状态
$_LANG['pick_up_status_0'] = "待提货";
$_LANG['pick_up_status_1'] = "已提货";
$_LANG['store_manage'] = "門店管理員";
