...
class TeamModuleSeeder extends Seeder
{
    ...
    private function touchAdPosition()
    {
        ...
        $result_bottom = DB::table('touch_ad_position')->whereIn('position_id',  [1003,1007])->where('tc_type', 'bottom')->count();
        if (!empty($result_bottom)) {
            // 删除无用广告位
            DB::table('touch_ad_position')->whereIn('position_id', [1003,1007])->where('tc_type', 'bottom')->delete();
        }
    ...
    private function touchAd()
    {
        ...
        $result_bottom = DB::table('touch_ad')->whereIn('position_id', [1003,1007])->count();
        if (!empty($result_bottom)) {
            // 删除无用广告
            DB::table('touch_ad')->whereIn('position_id', [1003,1007])->delete();
        }
