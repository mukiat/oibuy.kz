...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($name, function (Blueprint $table) {
            ...
            $table->integer('cloud_product_id')->unsigned()->default(0)->comment('云货品id');
            $table->integer('inventoryid')->unsigned()->default(0)->comment('库存id');
        });

        $prefix = config('database.connections.mysql.prefix');
        DB::statement("ALTER TABLE `" .$prefix. "$name` comment '商品货品'");
    }
