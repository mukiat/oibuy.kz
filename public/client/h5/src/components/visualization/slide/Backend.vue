<template>
    <div class="b-slide">
        <component-con :modules-index="modulesIndex" :component-name="componentName" :setting="setting">
            ...
            <img-ipt-url v-for="(item,index) in data.list" :key="item.key" :info="item" :modules-index="modulesIndex" :list-index="index" :b-edit-img="true" @setInfoValue="updateText" :bg-color="styleSel == 2 ? true : false">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            paginationSel:{
                get(){
                    return this.data.isPaginationSel
                },
                set(value){
                    this.updateRadioSel('isPaginationSel', value)
                }
            },
            separateSel:{
                get(){
                    return this.data.isSeparateSel
                },
                set(value){
                    this.updateRadioSel('isSeparateSel', value)
                }
            },
            data() {
