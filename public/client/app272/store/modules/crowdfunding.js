...
const mutations = {
    ...
    [SET_CROWD_SHOW](state, o) {
        state.crowdShowData = o;
    },
    [SET_CROWD_PROPERTY](state, o) {
        state.crowdPropertyData = o;
    },
    [SET_CROWD_CHECKOUT](state, o) {
        state.crowdCheckoutData = o;
    },
    ...
    [SET_CROWD_USER](state, o) {
        state.crowdUserData = o
    },
    [SET_CROWD_BUY](state, o) {
        state.crowdBuyData = o
    },
