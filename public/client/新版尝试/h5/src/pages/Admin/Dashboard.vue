<template>
  <div id="dashboard" class="dashboard">
    <ec-menu :pagesName="pagesName"></ec-menu>
    <ec-pages class="das-admin-pages" @activeName="activeName"></ec-pages>
    <div class="warpper" :class="{'close-page-list':!bPageListTitle,'warpper-no-right':device != 'h5'}">
      <ec-edit-area class="das-admin-edit-area"></ec-edit-area>
      <ec-preview-area class="das-admin-preview-area"></ec-preview-area>
      <ec-other-area class="das-admin-other-area" v-if="device == 'h5'"></ec-other-area>
    </div>
...
// custom components
import DialogUrl from '@/components/visualization/element/DialogUrl'
import DialogPicture from '@/components/visualization/element/DialogPicture'
import DialogGoods from '@/components/visualization/element/DialogGoods'
...
export default {
  ...
  data() {
    return {
      pagesName:'system',
      device:window.shopInfo.device ? window.shopInfo.device : 'h5'
    }
  },
  beforeMount() {
...
.warpper-no-right /deep/ .das-admin-edit-area{ right: 496px; }
.warpper-no-right /deep/ .das-admin-preview-area{ right: 12px; }
</style>