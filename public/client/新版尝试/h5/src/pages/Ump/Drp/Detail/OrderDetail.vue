						...
						<div class="flex_box">
							...
							<div class="flex_1 right flex_box fd_column jc_sb">
								...
								<div class="dis-box cont">
									...
									<div class="togglo_btn f-03 color-7" @click.stop="changeCollapse(index)"><span>{{activeNames.includes(index) ? 'Жинау' : 'Ашу'}}</span> <i :class="['iconfont', activeNames.includes(index) ? 'icon-less' : 'icon-moreunfold', 'ico']"></i></div>
								</div>
							</div>
						</div>
