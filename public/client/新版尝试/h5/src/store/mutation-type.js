...
const COPY_MODULES = 'dashboard/copyModules'
...
const UPDATE_GLOBAL_BGCOLOR = 'dashboard/updateGlobalBgColor'
const UPDATE_IS_SHOW = 'dashboard/updateIsShow'
...
const UPDATE_USER_PROFILE = 'updateProfile'
const UPDATE_USER_PROFILE_AVATAR = 'userUpdateAvatar'
...
const CLEAR_MATERIAl_IMG = 'clearMaterialImg'
...
const SECKILL_ATTR = 'setSeckillAttrPrice'
...
const UPDATE_SCROLLPICK_OPEN = 'updateScrollPickOpen'
...
export{
    ...
    UPDATE_GLOBAL_BGCOLOR, //修改可视化全局背景颜色(根据轮播)
    UPDATE_IS_SHOW,//首页顶级分类是否显示
    ...
    USER_REGISTER,//用户注册
    USER_PROFILE,//用户信息
    UPDATE_USER_PROFILE,//修改用户信息
    UPDATE_USER_PROFILE_AVATAR,//修改用户头像
    USER_ADDRESS,//收货地址
