...
$(function(){
	...
	$(".admin-logo a").on("click",function(){
		...
		$(".module-menu").find("*[ectype='menuLi']").removeClass("active");
	...
	//顶部导航栏菜单切换
	$(".module-menu *[ectype='menuLi']").on("click",function(){
		...
		if(type == 'gengduo'){
			...
			$(".module-menu").find(".gengduo").addClass("active");
		}else{
			$(".module-menu").find(".gengduo dd").removeClass("active");
		}
