    ...
    <div class="site wrapper">
        ...
        <div class="ecsc-layout-right">
            <div class="main-content" id="mainContent">
                {{--当前位置--}}
                <div class="ecsc-path"><span>{{ __('admin/goods_label.goods') }} - {{ __('admin/goods_label.bind_goods') }}</span></div>

                <div class="tabmenu">
                    <ul class="tab">
                        <li class="active" ><a href="javascript:;">{{ __('admin/goods_label.bind_goods') }}</a></li>
                    </ul>
                </div>

                <div class="btn fr mb10">
                    <a class="sc-btn sc-blue-btn" href="{{ route('seller/goodslabel/list', ['type' => 1]) }}"><i class="fa fa-reply"></i>{{ __('admin/goods_label.label_type_1') }}</a>
                </div>
                <div class="clear"></div>
                ...
                <div class="wrapper-right of">
                    ...
                    <div class="common-head mt20">
                        ...
                        <div class="fl">
                            ...
                            <a  href="{!! route('seller/goodslabel/select_goods', ['label_id' => $label_id, 'type' => $type]) !!}" class="sc-btn sc-blue-btn  fancybox fancybox.iframe"  ><i class="fa fa-plus"></i>{{ __('admin/common.select_goods') }}</a>
                        </div>
                    ...
                    <div class="wrapper-list mt20">
                        <div class="list-div" id="listDiv">
                            @include('seller.goodslabel.library.bind_goods_query')
                        </div>
                    </div>
    ...
    function confirm_batch() {
        ...
        if (ids) {
            ...
            layer.confirm('{{  __('admin/common.confirm_delete') }} ', {
                ...
                $.post("{{ route('seller/goodslabel/unbind_goods', ['label_id' => $label_id]) }}", {
                    goods_id: ids,
                }, function (data) {
                    layer.msg(data.msg);
                    if (data.error == 0) {
