...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/seller/css/wxshop.css') }}">
    ...
    <script type="text/javascript" src="{{ __ROOT__ }}js/jquery-1.12.4.min.js"></script>
    <script type="text/javascript" src="{{ __ROOT__ }}js/jquery.json.js"></script>
    <script type="text/javascript" src="{{ __ROOT__ }}js/transport_jquery.js"></script>
    <script type="text/javascript" src="{{ __ROOT__ }}js/utils.js"></script>
