...
>
                	<div class="cite"><span>
@if($title['parentType']['sub_shoprz_type'] == 1)
{{ $lang['subShoprz_type']['0'] }}
@elseif ($title['parentType']['sub_shoprz_type'] == 2)
{{ $lang['subShoprz_type']['1'] }}
@elseif ($title['parentType']['sub_shoprz_type'] == 3)
...
>
                    <div class="item-item"
@if($title['parentType']['sub_shoprz_type'] == 2)
 style="display:block;"
@else
 style="display:none;"
@endif
 id="subShoprz_type2">
                        ...
                        <div class="item-warp">
                            ...
                            <div class="text_time">
                                <input id="shop_expireDateStart" class="text text-2 jdate narrow" type="text" size="20" readonly value="{{ $title['parentType']['shop_expire_date_start'] }}" name="ec_shop_expireDateStart">
                                <span>&mdash;</span>
                                <input id="shop_expireDateEnd" class="text text-2 jdate narrow" type="text" size="20" readonly value="{{ $title['parentType']['shop_expire_date_end'] }}" name="ec_shop_expireDateEnd" >
                        ...
                        <div class="item-warp" id="container2">
                            ...
                            <div class="item-con">
                            	<div class="type-file-box">
                                    ...
                                    <input type="file" name="ec_authorizeFile" class="type-file-file" value="{{ $title['parentType']['authorize_file'] }}" data-state="" hidefocus="true" />

@if($title['parentType']['authorize_file'])
<a href="{{ $title['parentType']['authorize_file'] }}" class="chakan" target="_blank">{{ $lang['view'] }}</a>
@endif

                                    <input type="text" name="textfile" class="type-file-text" value="{{ $title['parentType']['authorize_file'] }}" readonly />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="item-item"
@if($title['parentType']['sub_shoprz_type'] == 3)
 style="display: block;"
@else
 style="display: none;"
@endif
 id="subShoprz_type3">
                        <div class="item-warp">
                            ...
                            <div id="container1" class="item-con">
                                <div class="type-file-box">
                                    <input type="button" name="button" class="type-file-button" id="button" value="" />
                                    <input type="file" name="ec_shop_hypermarketFile" class="type-file-file" value="{{ $title['parentType']['shop_hypermarket_file'] }}" data-state="" hidefocus="true" />

@if($title['parentType']['shop_hypermarket_file'])
<a href="{{ $title['parentType']['shop_hypermarket_file'] }}" class="chakan" target="_blank">{{ $lang['view'] }}</a>
@endif

                                    <input type="text" name="textfile" class="type-file-text" value="{{ $title['parentType']['shop_hypermarket_file'] }}" readonly />
                                </div>
                            </div>
                        </div>
                    </div>
...
@if($cross_border_version)
        ...
        <div class="item">
            ...
            <div class="value">
                @foreach($cross_source as $key=>$domestic_warehouse)
                <input type="radio" name="huoyuan" value="{{ $domestic_warehouse }}" @if($source && $source == $domestic_warehouse) checked="checked" @elseif($key == 0) checked="checked" @endif />{{ $domestic_warehouse }}&nbsp;&nbsp;
                @endforeach
            </div>
        </div>
@endif
