...
<div class="g-d-store-info">
	<div class="item">
		<a href="{{ $goods['store_url'] }}" class="s-name" target="_blank">{{ $goods['rz_shop_name'] }}</a>
		<a id="IM" onclick="openWin(this)" href="javascript:void(0);"  goods_id="{{ $goods['goods_id'] }}" class="s-a-kefu"><i class="icon i-kefu"></i></a>
	</div>
