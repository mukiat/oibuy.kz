...
@endif
                    ...
                    <div class="seller-info">
                    	<a href="{{ $goods['store_url'] }}" title="{{ $goods['rz_shop_name'] }}" target="_blank" class="name">{{ $goods['rz_shop_name'] }}</a>
                        <a id="IM" onclick="openWin(this)" href="javascript:void(0);" ru_id="{{ $goods['user_id'] }}"><i class="icon i-kefu"></i></a>
                    </div>
