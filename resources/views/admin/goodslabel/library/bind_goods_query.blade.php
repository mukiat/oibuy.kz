...
<table cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        ...
        <td class="handle">
            <div class="tDiv a2">
                <a href="javascript:;" data-href="{{ route('admin/goodslabel/unbind_goods', ['label_id' => $val['label_id'], 'goods_id'=> $val['goods_id']]) }}" class="btn_trash js-delete"><i class="fa fa-trash-o"></i>{{ __('admin/common.drop') }}</a>
            </div>
        </td>
    </tr>
