...
<div class="warpper">
    <div class="title"><a href="{{ route('admin/goodslabel/list') }}" class="s-back">{{ __('admin/common.back') }}</a>{{ __('admin/goods_label.goods') }}
        - {{ __('admin/goods_label.add_label') }}</div>
    <div class="content">
            ...
            <div class="main-info of">
                <form action="{{ route('admin/goodslabel/update') }}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                    <div class="switch_info of">
                        <div class="item">
                            <div class="label-t"><em class="color-red">*</em> {{ __('admin/goods_label.label_name') }}：</div>
                            <div class="label_value">
                                <input type="text" name="data[label_name]" value="{{ $label_info['label_name'] }}" class="text"/>
                                <div class="notic">{{ __('admin/goods_label.label_name_notice') }}</div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="label-t"><em class="color-red">*</em> {{ __('admin/goods_label.label_image') }}：</div>
                            <div class="label_value">
                                ...
                                @if($type == 1)
                                    <div class="notic">{{ __('admin/goods_label.label_image_notice_1') }}</div>
                                @else
                                    <div class="notic">{{ __('admin/goods_label.label_image_notice') }}</div>
                                @endif
                        ...
                        @if($type == 1)
                        <div class="item">
                            <div class="label-t"><em class="color-red">*</em> {{ __('admin/goods_label.label_show_time') }}：</div>
                            <div class="label_value">
                                ...
                                <div class="notic">{{ __('admin/goods_label.label_show_time_notice') }}</div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="label-t"><em class="color-red">*</em> {{ __('admin/goods_label.sort') }}：</div>
                            <div class="label_value">
                                <input type="text" name="data[sort]" value="{{ $label_info['sort'] ?? 50 }}" class="text w100"/>
                                <div class="notic">{{ __('admin/goods_label.sort_notice') }}</div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="label-t">{{ __('admin/goods_label.merchant_use') }}：</div>
                            <div class="label_value">
                                ...
                                <div class="notic">{{ __('admin/goods_label.merchant_use_notice') }}</div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="label-t">{{ __('admin/goods_label.status') }}：</div>
                            <div class="label_value">
                                <div class="checkbox_items">
                                    <div class="checkbox_item">
                                        ...
                                        <label for="status_1" class="ui-radio-label @if($label_info['status'] == 1) active @endif">{{ __('admin/goods_label.use') }}</label>
                                    </div>
                                    <div class="checkbox_item">
                                        ...
                                        <label for="status_0" class="ui-radio-label @if($label_info['status'] == 0) active @endif">{{ __('admin/goods_label.no_use') }}</label>
                                    </div>
                                </div>
                                <div class="notic">{{ __('admin/goods_label.status_notice') }}</div>
                            </div>
                        </div>

                        @if($type == 0)
                        <div class="item">
                            <div class="label-t">{{ __('admin/goods_label.label_url') }}：</div>
                            <div class="label_value">
                                <input type="text" name="data[label_url]" value="{{ $label_info['label_url'] }}" class="text"/>
                                <div class="notic">{{ __('admin/goods_label.label_url_notice') }}</div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="item">
                            ...
                            <div class="label_value info_btn">
                                ...
                                <input type="hidden" name="data[type]" value="{{ $type ?? 0 }}"/>
