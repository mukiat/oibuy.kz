...
<div class="warpper">
    <div class="title"><a href="{{ route('admin/goodsserviceslabel/list', ['type' => $type]) }}" class="s-back">{{ __('admin/common.back') }}</a>{{ __('admin/goods_services_label.goods') }} - {{ __('admin/goods_services_label.bind_goods') }}</div>
    <div class="content">
        ...
        <div class="flexilist">
            ...
            <div class="common-head">
                <div class="fl">
                    <a href="{!! route('admin/goodsserviceslabel/select_goods', ['label_id' => $label_id, 'type' => $type]) !!}" class="fancybox fancybox.iframe">
                        <div class="fbutton">
                ...
                <div class="search">
                    <form action="javascript:search();" method="post" name="searchForm">
                        <div class="select_w140 imitate_select ">
                            ...
                            <ul>
                                <li><a href="javascript:;" data-value="-1">{{ __('admin/goods_services_label.shop_keywords') }}</a></li>
            ...
            <div class="common-content">
                <div class="list-div" id="listDiv">
                    @include('admin.goodsserviceslabel.library.bind_goods_query')
                </div>
            </div>
    ...
    function confirm_batch() {
        ...
        if (ids) {
            ...
            layer.confirm('{{  __('admin/common.confirm_delete') }} ', {
                ...
                $.post("{{ route('admin/goodsserviceslabel/unbind_goods', ['label_id' => $label_id]) }}", {
                    goods_id: ids,
                }, function (data) {
                    layer.msg(data.msg);
                    if (data.error == 0) {
