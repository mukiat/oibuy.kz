        ...
        <div class="content">
            <div class="main-info">
                ...
                <div class="switch_info" style="overflow:inherit;">
                    ...
                    <!--搜索-->
                    <form method="post" action="{{ route('admin/goodsserviceslabel/select_goods', ['label_id' => $filter['label_id']]) }}" role="form" id="group_buy_form" class="validation">
...
<script type="text/javascript">
    $(function () {
        ...
        $(".confrim").click(function () {
            ...
            if (str) {
                // 请求
                var url = "{!! route('admin/goodsserviceslabel/bind_goods', ['label_id' => $filter['label_id'], 'handler' => 'import']) !!}";
