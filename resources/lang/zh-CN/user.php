...
$_LANG['vc_use_expire'] = '您的储值卡已经过使用期！';
$_LANG['vc_no_use_order'] = '您的储值卡无法用于此订单！';
$_LANG['vc_use_inspire'] = '您的储值卡还未开始使用！';
$_LANG['vc_limit_expire'] = '超出此类储值卡可绑定张数限制！';
$_LANG['vc_use_invalid'] = '您输入的储值卡已经失效';
...
$_LANG['ss'][OS_SHIPPED_PART] = '已发货(部分商品)';
$_LANG['ss'][SS_PART_RECEIVED] = '部分已收货';
$_LANG['ss'][SS_TO_BE_SHIPPED] = '待发货';
...
$_LANG['current_os_not_shipping'] = '当前订单未发货，你可以与店主联系。';
...
$_LANG['passport_js']['username_empty'] = '请输入用户名';
$_LANG['passport_js']['username_shorter'] = '用户名长度不能少于 4 个字符。';
$_LANG['passport_js']['username_invalid'] = '用户名只能是由字母数字以及下划线组成。';
$_LANG['passport_js']['password_empty'] = '请输入密码';
$_LANG['passport_js']['password_shorter'] = '登录密码不能少于 8 个字符。';
...
$_LANG['passport_js']['msg_un_length'] = '用户名最长不得超过15个字符，一个汉字等于2个字符';
...
$_LANG['passport_js']['msg_email_format'] = '格式错误，请输入正确的邮箱地址';
...
$_LANG['passport_js']['msg_phone_blank'] = '手机号码不能为空';
$_LANG['passport_js']['msg_phone_registered'] = '手机已存在,请重新输入';
$_LANG['passport_js']['msg_phone_invalid'] = '无效的手机号码';
$_LANG['passport_js']['msg_phone_not_correct'] = '手机号码不正确，请重新输入';
$_LANG['passport_js']['msg_mobile_code_blank'] = '手机验证码不能为空';
$_LANG['passport_js']['msg_mobile_code_not_correct'] = '手机验证码不正确';

$_LANG['passport_js']['msg_confirm_pwd_blank'] = '确认密码不能为空';

$_LANG['passport_js']['msg_identifying_code'] = '验证码不能为空';
$_LANG['passport_js']['msg_identifying_not_correct'] = '验证码不正确';
...
$_LANG['total_goods_price'] = '商品总金额';
$_LANG['drp_goods_price'] = '计佣金额';
$_LANG['total_drp_goods_price'] = '商品计佣金额总和';
$_LANG['drp_money'] = '计佣佣金';
$_LANG['level_per'] = '分成层级比例';
$_LANG['value_card_discount'] = '储值卡折扣';
$_LANG['total_drp_money'] = '计佣佣金总额';
...
$_LANG['surplus_recharge_not_support'] = '余额充值暂不支持';
$_LANG['pwd_set'] = '密码已设置';
...
$_LANG['16_withdraw_number_empty'] = '请输入您的提现账户。';
...
$_LANG['bind_mobile_code_error'] = '短信验证码已失效，请重新获取';
...
$_LANG['msg_authoriza_expire'] = '授权信息已过期，请重新登录';
...
// 非法访问或访问出错
$_LANG['unauthorized_access'] = '非法访问或访问出错';
