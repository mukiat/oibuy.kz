...
return [
    ...
    // divide
    'bill_out_order_no' => 'Merchant billing number',
    'transaction_id' => 'Payment transaction number',
    'divide_order_id' => 'WeChat is the bill number',
    'should_amount' => 'Merchants share the amount',
    'should_proportion' => 'Merchants share proportion',
    'divide_status' => 'The fashionable state',
    'divide_status_0' => 'Not the fashionable',
    'divide_status_1' => 'Separate account processing',
    'divide_status_2' => 'Collecting a complete',
];
