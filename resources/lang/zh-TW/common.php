...
$_LANG['replace_order'] = '補充賬單';

$_LANG['update_main_order_pay'] = "操作【子訂單：%s】修改價格產生的訂單記錄：%s";
$_LANG['update_order_pay'] = "更新價格修改:%s";
$_LANG['pay_total_fee'] = '付款金額';
$_LANG['total_fee_detail'] = '原應付款金額：%s，現應付款金額：%s';
$_LANG['special_sale'] = '特賣';
