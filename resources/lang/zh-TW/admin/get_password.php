...
$_LANG['sr_admin_username'] = '輸入管理員賬號';
$_LANG['sr_email'] = '輸入電子郵箱';
$_LANG['return_login'] = '返回登錄';
$_LANG['reset_pwd'] = '重置密碼';
$_LANG['sr_new_pwd'] = '輸入新密碼';
...
$_LANG['js_languages']['new_password_error'] = '密碼格式不正確!';
...
$_LANG['send_mail_error'] = '郵件發送錯誤, 請檢查您的郵件伺服器設置!';
